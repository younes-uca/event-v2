package ma.sir.event.zynerator.security.jwt;
...
import ma.sir.event.EventApplication;
import ma.sir.event.zynerator.security.common.SecurityParams;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response,
        ...
        UserService userService = EventApplication.getCtx().getBean(UserService.class);
