...
@Component({
  selector: 'app-evenement-state-create-admin',
  templateUrl: './evenement-state-create-admin.component.html'
})
export class EvenementStateCreateAdminComponent extends AbstractCreateController<EvenementStateDto, EvenementStateCriteria, EvenementStateService>  implements OnInit {
