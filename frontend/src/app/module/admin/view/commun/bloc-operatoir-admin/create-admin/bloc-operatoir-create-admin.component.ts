...
@Component({
  selector: 'app-bloc-operatoir-create-admin',
  templateUrl: './bloc-operatoir-create-admin.component.html'
})
export class BlocOperatoirCreateAdminComponent extends AbstractCreateController<BlocOperatoirDto, BlocOperatoirCriteria, BlocOperatoirService>  implements OnInit {
